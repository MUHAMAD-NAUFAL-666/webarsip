...
<div class="container my-5 p-4 shadow-sm bg-white rounded" style="max-width: 600px; border: 2px solid #999999;">
    ...
    <input type="text" name="nomor_dokumen" class="form-control border-green" placeholder="Masukkan Nomor Dokumen" required>
</div>
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="peminjam" class="form-control border-green" placeholder="Masukkan Nama Peminjam"
                required>
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <input type="date" name="tanggal_peminjaman" class="form-control border-green" required>
        </div>
        <div class="form-group mb-3">
            <label class="form-label">Tanggal Pengembalian:</label>
            <input type="date" name="tanggal_pengembalian" class="form-control border-green" required>
        </div>
